...
df_pivot = df_pivot[df_pivot.sum(axis=1) > 0].sort_values(by=df_pivot.columns.tolist(), ascending=True).head(10)
df_pivot.columns.name = 'Via'
...
#Grafico de chegadas por via de transporte
